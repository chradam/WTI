...
send_put('New index = temp', '/indices/temp')
send_get('List indices', '/indices')
send_post('Reindex users into temp', '/reindex',
          {'source': 'users', 'dest': 'temp'})
send_get('List indices', '/indices')
...
send_delete('Remove index temp', '/indices/temp')
send_get('List indices', '/indices')
